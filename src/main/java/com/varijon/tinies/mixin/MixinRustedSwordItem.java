...
@Mixin(RustedSwordItem.class)
public class MixinRustedSwordItem extends HeldItem
{
	public MixinRustedSwordItem(EnumHeldItems heldItemType, Properties properties) {
	...
	public void onStartOfBattle(PixelmonWrapper pw) {
        if (pw.getSpecies().is(PixelmonSpecies.ZACIAN)) {
            ...
            for (Attack attack : moveset) {
                ...
                Attack newAttack = new Attack(AttackRegistry.BEHEMOTH_BLADE);
